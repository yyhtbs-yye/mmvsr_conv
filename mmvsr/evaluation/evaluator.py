...
from mmvsr.registry import EVALUATORS
...
class Evaluator(Evaluator):
    ...
    Score (IS, :class:`~mmvsr.evaluation.InceptionScore`) only needs to
    take fake images as input. However, Frechet Inception Distance (FID,
    :class:`~mmvsr.evaluation.FrechetInceptionDistance`) needs to take
    ...
    :class:`~mmvsr.evaluation.PerceptualPathLength`), generator need
    ...
    :meth:`mmvsr.engine.runner.MultiValLoop.run` and
    :meth:`mmvsr.engine.runner.MultiTestLoop.run`.
