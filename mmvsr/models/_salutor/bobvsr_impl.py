...
class BobVSRImpl(BaseModule):
    ...
    def __init__(self, mid_channels=64, num_blocks=30, spynet_pretrained=None, max_residue_magnitude=10):
        ...
        self.aligner_args = dict(in_channels=2*mid_channels, out_channels=mid_channels, 
                                 kernel_size=3, padding=1, deform_groups=16,
                                 max_residue_magnitude=max_residue_magnitude, order=2)
