...
from mmvsr.utils.typing import ForwardInputs, NoiseVar, SampleList
...
class BaseGAN(BaseModel, metaclass=ABCMeta):
    ...
    Args:
        ...
        data_preprocessor (Optional[Union[dict, Config]]): The pre-process
            config or :class:`~mmvsr.models.DataPreprocessor`.
    ...
    def train_step(self, data: dict,
        ...
        discriminator are updated alternatively. In mmvsr's design,
