...
def build_mmvsr_wrapper_tomesd_block(block_class: Type[torch.nn.Module]
                                      ) -> Type[torch.nn.Module]:
    """Make a patched class for a DiffusersWrapper model in mmvsr. This patch
...
def build_mmvsr_tomesd_block(block_class: Type[torch.nn.Module]
                              ) -> Type[torch.nn.Module]:
    """Make a patched class for a mmvsr StableDiffusion model. This patch
    applies ToMe to the forward function of the block.
