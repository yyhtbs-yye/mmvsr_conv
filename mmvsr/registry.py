...
"""Registries and utilities in mmvsr.
...
TRANSFORMS = Registry(
    ...
    locations=['mmvsr.datasets.transforms'],
)
...
DIFFUSION_SCHEDULERS = Registry(
    'diffusion scheduler',
    locations=['mmvsr.models.diffusion_schedulers'],
)
