...
from mmvsr.registry import VISBACKENDS


@VISBACKENDS.register_module()
class VisBackend(BaseVisBackend):
    """mmvsr visualization backend class. It can write image, config, scalars,
    ...
    Examples:
        >>> from mmvsr.visualization import VisBackend
        >>> import numpy as np
...
class WandbVisBackend(BaseWandbVisBackend):
    """Wandb visualization backend for mmvsr."""
