...
from .inferencers.base_mmvsr_inferencer import InputsType


class mmvsrInferencer:
    """mmvsrInferencer API for mmvsr models inference.
    ...
    def __init__(self,
        ...
        mmvsrInferencer.init_inference_supported_models_cfg()
        inferencer_kwargs = {}
    ...
    def init_inference_supported_models_cfg() -> None:
        if not mmvsrInferencer.inference_supported_models_cfg_inited:
            if osp.exists(
            ...
            for model_name in mmvsrInferencer.inference_supported_models:
                ...
                mmvsrInferencer.inference_supported_models_cfg[
                    model_name] = {}
                mmvsrInferencer.inference_supported_models_cfg[model_name][
                    'task'] = task  # noqa
                mmvsrInferencer.inference_supported_models_cfg[model_name][
                    'settings'] = parsed_yaml['Models']  # noqa

            mmvsrInferencer.inference_supported_models_cfg_inited = True

    @staticmethod
    def get_inference_supported_models() -> List:
        """static function for getting inference supported modes."""
        return mmvsrInferencer.inference_supported_models
    ...
    def get_inference_supported_tasks() -> List:
        ...
        supported_task = set()
        for key in mmvsrInferencer.inference_supported_models_cfg.keys():
            if mmvsrInferencer.inference_supported_models_cfg[key]['task'] \
               not in supported_task:
                supported_task.add(mmvsrInferencer.
    ...
    def get_task_supported_models(task: str) -> List:
        ...
        supported_models = []
        for key in mmvsrInferencer.inference_supported_models_cfg.keys():
            if mmvsrInferencer.inference_supported_models_cfg[key][
                    'task'] == task:
