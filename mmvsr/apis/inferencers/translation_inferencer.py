...
from mmvsr.models.base_models import BaseTranslationModel
from .base_mmvsr_inferencer import BasemmvsrInferencer, InputsType, PredType


class TranslationInferencer(BasemmvsrInferencer):
