...
from mmvsr.registry import DIFFUSION_SCHEDULERS, MODELS
from mmvsr.utils import ConfigType
from .base_mmvsr_inferencer import BasemmvsrInferencer
...
class ControlnetAnimationInferencer(BasemmvsrInferencer):
    """Base inferencer.
