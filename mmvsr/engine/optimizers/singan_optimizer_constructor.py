...
from mmvsr.registry import OPTIM_WRAPPER_CONSTRUCTORS
...
class SinGANOptimWrapperConstructor:
    ...
    :class:`~mmvsr.models.editors.singan.SinGANMultiScaleGenerator` and
    :class:`~mmvsr.models.editors.singan.SinGANMultiScaleDiscriminator`.
