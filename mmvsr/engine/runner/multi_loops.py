...
from mmvsr.registry import LOOPS
...
class MultiValLoop(BaseLoop):
    """Validation loop for mmvsr models which support evaluate multiply
...
class MultiTestLoop(BaseLoop):
    """Test loop for mmvsr models which support evaluate multiply dataset at
