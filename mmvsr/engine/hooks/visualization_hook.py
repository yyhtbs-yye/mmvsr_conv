...
from mmvsr.utils import get_sampler
...
class VisualizationHook(Hook):
    """mmvsr Visualization Hook. Used to visual output samples in training,
    ...
    - Required key words:
        - 'type': Value must be string. Denotes what kind of sampler is used to
            generate image. Refers to :meth:`~mmvsr.utils.get_sampler`.
    ...
    models supported in mmvsr. Refers to
