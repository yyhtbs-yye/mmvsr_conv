...
from mmvsr.evaluation import (Evaluator, FrechetInceptionDistance,
                               InceptionScore)
...
fid_loading_str = 'mmvsr.evaluation.metrics.fid.FrechetInceptionDistance._load_inception'  # noqa
is_loading_str = 'mmvsr.evaluation.metrics.inception_score.InceptionScore._load_inception'  # noqa
...
class TestEvaluator(TestCase):
    ...
    def test_prepare_metric(self):
        ...
        with patch('mmvsr.evaluation.metrics.fid.prepare_inception_feat'):
