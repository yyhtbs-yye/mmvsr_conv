...
from mmvsr.models import DenoisingUnet, DiscoDiffusion
from mmvsr.models.diffusion_schedulers import EditDDIMScheduler
...
class TestDiscoDiffusion(TestCase):
    ...
    def test_infer(self):
        ...
        mock_path = ('mmvsr.models.editors.disco_diffusion.guider.'
                     'TORCHVISION_VERSION')
        affine_mock_path = ('mmvsr.models.editors.disco_diffusion.guider.T.'
                            'RandomAffine')
