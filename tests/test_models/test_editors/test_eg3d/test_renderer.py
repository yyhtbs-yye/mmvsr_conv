...
from mmvsr.models.editors.eg3d.renderer import EG3DDecoder, EG3DRenderer
...
class TestEG3DRenderer(TestCase):
    ...
    def test_forward(self):
        ...
        mock_path = ('mmvsr.models.editors.eg3d.renderer.EG3DRenderer.'
                     'volume_rendering')
        ...
        mock_path = 'mmvsr.models.editors.eg3d.renderer.TORCH_VERSION'
