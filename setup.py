...
def get_hash():
    if os.path.exists('.git'):
        ...
        try:
            from mmvsr.version import __version__
...
def add_mim_extension():
    ...
    mim_path = osp.join(repo_path, 'mmvsr', '.mim')
...
if __name__ == '__main__':
    ...
    setup(
        ...
        url='https://github.com/open-mmlab/mmvsr',
