...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='Pretrained mmvsr algorithm')
    parser.add_argument(
        '--model-setting',
        type=int,
        default=None,
        help='Pretrained mmvsr algorithm setting')
    parser.add_argument(
        '--config-name',
        type=str,
        default=None,
        help='Pretrained mmvsr algorithm config name')
    parser.add_argument(
        '--model-config',
        type=str,
        default=None,
        help='Path to the custom config file of the selected mmvsr model.')
    parser.add_argument(
        '--model-ckpt',
        type=str,
        default=None,
...
def main():
    ...
    if args.print_supported_models:
        inference_supported_models = \
            mmvsrInferencer.get_inference_supported_models()
